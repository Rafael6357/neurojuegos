...
public class niveles_identifica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveles_identifica);

        puntostext=(TextView)findViewById(R.id.puntuaje_total_identifica);
        ...
        buttonPanelMinijuegos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(niveles_identifica.this, Panel_Minijuegos.class);
        ...
        int puntuacionIdentifica = 0;
        if (cursor.moveToFirst()) {
            puntuacionIdentifica = cursor.getInt(0);
        }
        cursor.close();
        db.close();


        puntostext.setText(String.valueOf(puntuacionIdentifica));

        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("puntuacion", puntuacionIdentifica);
        editor.apply();
    ...
    private void comprobar() {
        ...
        if (nivelestado == 2 ) {
            ...
            imb02.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(niveles_identifica.this,Identifica2.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 3 ) {
            ...
            imb03.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica3.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 4 ) {
            ...
            imb04.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica4.class);
        ...
        if (nivelestado == 5 ) {
            ...
            imb05.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica5.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 6 ) {
            ...
            imb06.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica6.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 7 ) {
            ...
            imb07.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica7.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 8 ) {
            ...
            imb08.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica8.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 9 ) {
            ...
            imb09.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica9.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 10 ) {
            ...
            imb09.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica10.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 11 ) {
            ...
            imb11.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica11.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 12 ) {
            ...
            imb12.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica12.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 13 ) {
            ...
            imb13.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica13.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 14 ) {
            ...
            imb14.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica14.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 15 ) {
            ...
            imb15.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica15.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 16 ) {
            ...
            imb16.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_identifica.this,Identifica16.class);
                    startActivity(intent);
                }
            });
    ...
    public void nivel1(View view){
        Intent i =new Intent(niveles_identifica.this,Identifica1.class);
        startActivity(i);
