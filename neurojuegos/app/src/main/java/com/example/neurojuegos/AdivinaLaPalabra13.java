...
public class AdivinaLaPalabra13 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 13;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("LUNA", "PAYASO", "DIENTE"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("LUNA", "Pista:Brilla en el cielo durante la noche..");
        put("PAYASO", "Pista:Un personaje gracioso que te hace reír en el circo.");
        put("DIENTE", "Pista:Lo tienes en la boca y debes cepillarlo.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra13);

        puntuajeTextView13 = (TextView) findViewById(R.id.puntuaje_adivina13);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("LUNA", "PAYASO", "DIENTE"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra13.this, VictoriaAdivinaLaPalabra.class);
