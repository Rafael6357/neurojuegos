...
public class niveles_frasesvof extends AppCompatActivity {

    private TextView puntostext;
    private int puntuajeTotal;
    private ImageView button_panel_niveles;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveles_frasesvof);

        puntostext=(TextView)findViewById(R.id.puntuaje_total_frasesvof);


        button_panel_niveles = findViewById(R.id.button_panel_niveles);

        button_panel_niveles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(niveles_frasesvof.this, Panel_Minijuegos.class);
        ...
        Cursor cursor = db.query("datos", new String[]{"puntuacionFrasesVoF"}, "nombre=?", new String[]{savedNames}, null, null, null);        int puntuacionFoV = 0;
        if (cursor.moveToFirst()) {
            puntuacionFoV = cursor.getInt(0);
        }
        cursor.close();
        db.close();

        puntostext.setText(String.valueOf(puntuacionFoV));

        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("puntuacion", puntuacionFoV);
        editor.apply();
    ...
    private void comprobar() {
        ...
        if (nivelestado == 2 ) {
            ...
            imb02.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb02.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_2nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 3 ) {
            ...
            imb03.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap1 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb03.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_3nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 4 ) {
            ...
            imb04.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap3 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb04.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_4nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 5 ) {
            ...
            imb05.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap4 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb05.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_5nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 6 ) {
            ...
            imb06.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap5 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb06.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_6nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 7 ) {
            ...
            imb07.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap7 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb07.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_7nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 8 ) {
            ...
            imb08.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap8 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb08.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_8nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 9 ) {
            ...
            imb09.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap10 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb09.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_9nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 10 ) {
            ...
            imb10.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap11 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb10.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_10nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 11 ) {
            ...
            imb10.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap90 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb11.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap11 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            Bitmap resizedBitmap11 = Bitmap.createScaledBitmap(originalBitmap, 165, 200, true);
            ...
            imb11.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_11nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 12 ) {
            ...
            imb09.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap9 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb12.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap91 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb12.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_12nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 13 ) {
            ...
            imb13.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap96 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb13.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_13nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 14 ) {
            ...
            imb14.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap97 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb14.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_14nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 15 ) {
            ...
            imb15.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap98 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb15.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_15nivel.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 16 ) {
            ...
            imb16.setImageResource(R.drawable.imagen_nivel_disponible);
            Bitmap originalBitmap99 = BitmapFactory.decodeResource(getResources(), R.drawable.imagen_nivel_disponible);
            ...
            imb16.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_frasesvof.this,FrasesVoF_16nivel.class);
                    startActivity(intent);
                }
            });
    ...
    public void nivel1(View view){
        Intent i =new Intent(niveles_frasesvof.this,FrasesVoF_1nivel.class);
        startActivity(i);
