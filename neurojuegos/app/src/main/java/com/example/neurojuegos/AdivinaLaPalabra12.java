...
public class AdivinaLaPalabra12 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 12;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("BAÑARME", "FLOR", "HELADO"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("BAÑARME", "Pista: Lo haces con agua y jabón para estar limpio.");
        put("FLOR", "Pista:Tiene pétalos y suele ser muy colorida.");
        put("HELADO", "Pista:Un postre frío y sabroso que se derrite rápidamente.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra12);

        puntuajeTextView12 = (TextView) findViewById(R.id.puntuaje_adivina12);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("BAÑARME", "FLOR", "HELADO"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra12.this, VictoriaAdivinaLaPalabra.class);
