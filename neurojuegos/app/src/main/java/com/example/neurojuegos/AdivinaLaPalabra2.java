...
public class AdivinaLaPalabra2 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 2;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("LIBRO", "AULA", "MESA"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("LIBRO", "Pista: Contiene muchas páginas con información, historias o imágenes.");
        put("AULA", "Pista:Es un espacio dentro de la escuela donde los estudiantes se reúnen para recibir clases y aprender.");
        put("MESA", "Pista:Es un mueble que se utiliza para trabajar, estudiar o comer. Tiene una superficie plana y generalmente cuatro patas.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra2);

        puntuajeTextView2 = (TextView) findViewById(R.id.puntuaje_adivina2);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("LIBRO", "AULA", "MESA"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra2.this, VictoriaAdivinaLaPalabra.class);
