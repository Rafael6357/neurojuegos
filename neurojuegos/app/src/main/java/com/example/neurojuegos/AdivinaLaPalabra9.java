...
public class AdivinaLaPalabra9 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 9;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("BAÑO", "CUARTO", "LIBRO"));
    ...
    private TextView puntuajeTextView9;

    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("BAÑO", "Pista:Lugar donde te bañas y te cepillas los dientes.");
        put("CUARTO", "Pista: Donde duermes y guardas tus cosas.");
        put("LIBRO", "Pista: Tienes muchas páginas y puedes leerlo.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra9);

        puntuajeTextView9 = (TextView) findViewById(R.id.puntuaje_adivina9);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("BAÑO", "CUARTO", "LIBRO"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            puntuajeTextView9.setText(String.valueOf(puntos));
            ...
            Intent intent = new Intent(AdivinaLaPalabra9.this, VictoriaAdivinaLaPalabra.class);
