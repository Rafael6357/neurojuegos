...
public class AdivinaLaPalabra11 extends AppCompatActivity {
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("ALMUERZO", "Pista:La comida que comes en la mitad del día.");
        put("ROPA", "Pista:Lo que te pones para vestirte.");
        put("COMIDA", "Pista:Aquello que te da energía y te gusta comer.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra11);

        puntuajeTextView11 = (TextView) findViewById(R.id.puntuaje_adivina11);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("ALMUERZO", "ROPA", "COMIDA"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra11.this, VictoriaAdivinaLaPalabra.class);
