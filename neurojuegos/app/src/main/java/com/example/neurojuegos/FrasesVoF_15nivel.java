...
public class FrasesVoF_15nivel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frases_vo_f15nivel);
        puntuajeTextView15=(TextView)findViewById(R.id.puntuaje_frasesvof15) ;

        // Obtener la referencia del botón verificar
        Button verificarButton15 = findViewById(R.id.verificar15activity_vof);

        // Agregar el método onClick al botón verificar
        verificarButton15.setOnClickListener(new View.OnClickListener() {
            @Override
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(FrasesVoF_15nivel.this, Victoria.class);
