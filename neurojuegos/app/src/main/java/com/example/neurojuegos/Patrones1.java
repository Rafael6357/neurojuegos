...
public class Patrones1 extends AppCompatActivity {
    ...
    private Button verificarButton1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patrones1);
        puntuajeTextView1 = (TextView) findViewById(R.id.puntuaje_patrones1);
        ...
        Button verificarButton1 = findViewById(R.id.verificar1patrones);
        ...
        verificarButton1 = findViewById(R.id.verificar1patrones);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                // Ocultamos la imagen 1 después de que haya transcurrido el tiempo del temporizador
                imageview1.setVisibility(View.INVISIBLE);
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        // Ocultamos la imagen 2 después de 1 segundo
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // Mostramos todas las imágenes al mismo tiempo después de ocultar la imagen 3
                                handler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
    ...
    public void Verificar1Respuesta() {
        ...
        if (radio2.isChecked() && !radio1.isChecked() && !radio3.isChecked() && !radio4.isChecked() ) {
            // Obtener la puntuación actual del TextView
            puntos = 5;

            // Actualizar el valor del puntuaje en el TextView
            puntuajeTextView1.setText(String.valueOf(puntos));
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            int valor = 2;
            ...
            Intent intent = new Intent(Patrones1.this, VictoriaPatrones.class);
