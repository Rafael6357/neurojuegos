...
public class Recuerda3 extends AppCompatActivity {
    ...
    private String[] items = {"libro", "mochila", "cama", "guineo"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recuerda3);
        ...
        regresarANiveles11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Recuerda3.this, niveles_recuerda.class);
    ...
    private void hacerInvisible(){
        ...
        showMessage("Toca el recuadro donde se encontraba una mochila.");
        ...
        visible2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Recuerda3.this, VictoriaRecuerda.class);
                startActivity(intent);
            }
        });
