...
public class AdivinaLaPalabra14 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 14;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("REGALO", "PRINCESA", "PERRO"));
    ...
    private TextView puntuajeTextView14;

    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("REGALO", "Pista: Es algo que recibes de alguien en una ocasión especial.");
        put("PRINCESA", "Pista:Es una joven de nobleza y belleza en los cuentos de hadas.");
        put("PERRO", "Pista:Es el mejor amigo del hombre y hace \"guau\".");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra14);

        puntuajeTextView14 = (TextView) findViewById(R.id.puntuaje_adivina14);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("REGALO", "PRINCESA", "PERRO"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            puntuajeTextView14.setText(String.valueOf(puntos));
            ...
            Intent intent = new Intent(AdivinaLaPalabra14.this, VictoriaAdivinaLaPalabra.class);
