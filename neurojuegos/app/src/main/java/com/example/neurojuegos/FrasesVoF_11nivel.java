...
public class FrasesVoF_11nivel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frases_vo_f11nivel);
        puntuajeTextView11=(TextView)findViewById(R.id.puntuaje_frasesvof11) ;

        // Obtener la referencia del botón verificar
        Button verificarButton11 = findViewById(R.id.verificar11activity_vof);

        // Agregar el método onClick al botón verificar
        verificarButton11.setOnClickListener(new View.OnClickListener() {
            @Override
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(FrasesVoF_11nivel.this, Victoria.class);
