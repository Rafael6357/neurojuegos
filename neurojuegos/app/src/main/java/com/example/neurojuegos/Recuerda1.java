...
public class Recuerda1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recuerda1);
        ...
        regresarANiveles11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Recuerda1.this, niveles_recuerda.class);
    ...
    private void hacerInvisible(){
        ...
        visible1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Recuerda1.this, VictoriaRecuerda.class);
                startActivity(intent);
            }
        });
