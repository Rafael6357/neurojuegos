...
public class Identifica12 extends AppCompatActivity {
    private TextView puntuajeTextView12;
    private String nombreJugadorActual;
    private int nivelActual = 12;
    private Button reiniciarButton;
    private Button verificarButton12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica12);
        puntuajeTextView12 = (TextView) findViewById(R.id.puntuaje_identifica12);


        // Obtener la referencia del botón verificar
        Button verificarButton12 =(Button) findViewById(R.id.verificar12activityidentifica);

        // Agregar el método onClick al botón verificar
        verificarButton12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Verificar12Respuesta();
            }
        });

        // Obtener la referencia del botón volver a niveles
        ImageView regresarANiveles12 = findViewById(R.id.regresarANiveles12);

        // Agregar el método onClick del botón volver a niveles
        regresarANiveles12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Volver_A_Niveles();
            }
    ...
    public void Verificar12Respuesta() {
        ...
        if (chSeleccionado1.isChecked() && chSeleccionado4.isChecked() && !chSeleccionado2.isChecked() && !chSeleccionado3.isChecked() ) {
            ...
            puntuajeTextView12.setText(String.valueOf(puntos));
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            int valor = 13;
            ...
            Intent intent = new Intent(Identifica12.this, VictoriaIdentifica.class);
