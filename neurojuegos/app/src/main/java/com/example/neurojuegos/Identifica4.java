...
public class Identifica4 extends AppCompatActivity {
    private TextView puntuajeTextView4;
    private String nombreJugadorActual;
    private int nivelActual = 4;
    private Button reiniciarButton;
    private Button verificarButton4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica4);
        puntuajeTextView4 = (TextView) findViewById(R.id.puntuaje_identifica4);

        // Obtener la referencia del botón verificar
        Button verificarButton4 =(Button) findViewById(R.id.verificar4activityidentifica);

        // Agregar el método onClick al botón verificar
        verificarButton4.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ImageView regresarANiveles4 = findViewById(R.id.regresarANiveles4);

        // Agregar el método onClick del botón volver a niveles
        regresarANiveles4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Volver_A_Niveles();
            }
    ...
    public void Verificar4Respuesta() {
        ...
        if (chSeleccionado1.isChecked() && chSeleccionado2.isChecked() && !chSeleccionado3.isChecked() && !chSeleccionado4.isChecked() ) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Toast.makeText(this, "¡WOW!! Has ganado 2 puntos.", Toast.LENGTH_SHORT).show();

            // Después de incrementar nivelActual
            Intent intent = new Intent(Identifica4.this, VictoriaIdentifica.class);
