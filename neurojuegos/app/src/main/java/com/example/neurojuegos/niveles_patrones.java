...
public class niveles_patrones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveles_patrones);

        puntostext=(TextView)findViewById(R.id.puntuaje_total_patrones);
        ...
        buttonPanelMinijuegos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(niveles_patrones.this, Panel_Minijuegos.class);
        ...
        int puntuacionPatrones = 0;
        if (cursor.moveToFirst()) {
            puntuacionPatrones = cursor.getInt(0);
        }
        cursor.close();
        db.close();

        puntostext.setText(String.valueOf(puntuacionPatrones));

        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt("puntuacion", puntuacionPatrones);
        editor.apply();
    ...
    private void comprobar() {
        ...
        if (nivelestado == 2 ) {
            ...
            imb02.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(niveles_patrones.this,Patrones2.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 3 ) {
            ...
            imb03.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones3.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 4 ) {
            ...
            imb04.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones4.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 5 ) {
            ...
            imb05.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones5.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 6 ) {
            ...
            imb06.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones6.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 7 ) {
            ...
            imb07.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones7.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 8 ) {
            ...
            imb08.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones8.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 9 ) {
            ...
            imb09.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones9.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 10 ) {
            ...
            imb10.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones10.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 11 ) {
            ...
            imb11.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones11.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 12 ) {
            ...
            imb12.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones12.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 13 ) {
            ...
            imb13.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones13.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 14 ) {
            ...
            imb14.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones14.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 15 ) {
            ...
            imb15.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones15.class);
                    startActivity(intent);
                }
            });
        ...
        if (nivelestado == 16 ) {
            ...
            imb16.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Aquí puedes agregar el código para navegar a la nueva actividad
                    Intent intent = new Intent(niveles_patrones.this,Patrones16.class);
                    startActivity(intent);
                }
            });
    ...
    public void nivel1(View view){
        Intent i =new Intent(niveles_patrones.this,Patrones1.class);
        startActivity(i);
