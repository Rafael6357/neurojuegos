...
public class FrasesVoF_1nivel extends AppCompatActivity {
    private TextView puntuajeTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frases_vo_f_1nivel);
        puntuajeTextView = findViewById(R.id.puntuaje_frasesvof);

        // Obtener la referencia del botón verificar
        Button verificarButton1 = findViewById(R.id.verificar1activity_vof);
    ...
    public void Volver_A_Niveles(){
        Intent i =new Intent(FrasesVoF_1nivel.this,niveles_frasesvof.class);
        startActivity(i);
    ...
    public void Verificar1Respuesta() {
                ...
                if (rbVerdaderoSeleccionado1.isChecked() && rbFalsoSeleccionado4.isChecked()) {
                    ...
                    puntuajeTextView.setText(String.valueOf(puntos));
                    ...
                    Intent intent = new Intent(FrasesVoF_1nivel.this, Victoria.class);
