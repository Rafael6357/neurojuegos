...
public class AdivinaLaPalabra15 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 15;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("SOL", "CASA", "ABEJA"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("SOL", "Pista:Sale en el cielo durante el día y nos da luz y calor.");
        put("CASA", "Pista: Es un lugar donde vivimos y nos sentimos seguros.");
        put("ABEJA", "Pista:Es un insecto volador que produce miel.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra15);

        puntuajeTextView15 = (TextView) findViewById(R.id.puntuaje_adivina15);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("SOL", "CASA", "ABEJA"));
    ...
    public void iniciarJuego() {
        ...
        intentosRestantes = 3;
        if (imagenAhorcado3 != null) imagenAhorcado3.setImageResource(R.drawable.imagen_ahorcado_impar);
        if (imagenAhorcado2 != null) imagenAhorcado2.setImageResource(R.drawable.imagen_ahorcado_par);
        if (imagenAhorcado1 != null) imagenAhorcado1.setImageResource(R.drawable.imagen_ahorcado_impar);
        if (imagenAhorcado0 != null) imagenAhorcado0.setImageResource(R.drawable.imagen_ahorcado_par);
        ...
        if (textoIntentosRestantes != null) {
    ...
    public void ingresarLetra(View view) {
        ...
        if (!letraEncontrada) {
            ...
            switch (intentosRestantes) {
                case 3:
                    if (imagenAhorcado3 != null) imagenAhorcado3.setVisibility(View.GONE);
                    break;
                case 2:
                    if (imagenAhorcado2 != null) imagenAhorcado2.setVisibility(View.GONE);
                    break;
                case 1:
                    if (imagenAhorcado1 != null) imagenAhorcado1.setVisibility(View.GONE);
                    break;
                case 0:
                    if (imagenAhorcado0 != null) imagenAhorcado0.setVisibility(View.GONE);
                    break;
            }
        }
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            if (savedNames != null && !savedNames.isEmpty()) {
                ...
                Intent intent = new Intent(AdivinaLaPalabra15.this, VictoriaAdivinaLaPalabra.class);
