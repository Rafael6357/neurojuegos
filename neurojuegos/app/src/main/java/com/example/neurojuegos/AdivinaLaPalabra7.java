...
public class AdivinaLaPalabra7 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 7;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("ESCUELA", "CASA", "COCINA"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("ESCUELA", "Pista: Lugar donde aprendes y estudias..");
        put("CASA", "Pista:Donde vives con tu familia");
        put("COCINA", "Pista:Lugar donde se prepara la comida.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra7);

        puntuajeTextView7 = (TextView) findViewById(R.id.puntuaje_adivina7);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("ESCUELA", "CASA", "COCINA"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra7.this, VictoriaAdivinaLaPalabra.class);
