...
public class Recuerda2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recuerda2);
        ...
        regresarANiveles11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Recuerda2.this, niveles_recuerda.class);
    ...
    private void hacerInvisible(){
        ...
        showMessage("Toca el recuadro donde se encontraba un guineo.");
        ...
        visible4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Recuerda2.this, VictoriaRecuerda.class);
                startActivity(intent);
            }
        });
