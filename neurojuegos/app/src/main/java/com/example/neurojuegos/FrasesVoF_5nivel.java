...
public class FrasesVoF_5nivel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frases_vo_f5nivel);
        puntuajeTextView5=(TextView)findViewById(R.id.puntuaje_frasesvof5) ;

        // Obtener la referencia del botón verificar
        Button verificarButton5 = findViewById(R.id.verificar5activity_vof);
    ...
    public void Verificar5Respuesta() {
        ...
        if (rbVerdaderoSeleccionado1.isChecked() && rbFalsoSeleccionado4.isChecked()) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(FrasesVoF_5nivel.this, Victoria.class);
