...
public class Identifica6 extends AppCompatActivity {
    private TextView puntuajeTextView6;
    private String nombreJugadorActual;
    private int nivelActual = 6;
    private Button reiniciarButton;
    private Button verificarButton6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica6);
        puntuajeTextView6 = (TextView) findViewById(R.id.puntuaje_identifica6);

        // Obtener la referencia del botón verificar
        Button verificarButton6 =(Button) findViewById(R.id.verificar6activityidentifica);
    ...
    public void Verificar6Respuesta() {
        ...
        if (chSeleccionado3.isChecked() &&  !chSeleccionado1.isChecked() &&  !chSeleccionado2.isChecked() && !chSeleccionado4.isChecked() ) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(Identifica6.this, VictoriaIdentifica.class);
