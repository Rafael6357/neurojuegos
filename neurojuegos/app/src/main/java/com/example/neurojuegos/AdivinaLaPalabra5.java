...
public class AdivinaLaPalabra5 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 5;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("ABRIGO", "PEINE", "MAESTRO"));
    ...
    private TextView puntuajeTextView5;

    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("ABRIGO", "Pista:Es una prenda de vestir que se usa para protegerse del frío y que cubre el cuerpo.");
        put("PEINE", "Pista:Es la acción de arreglar el cabello antes de ir a la escuela.");
        put("MAESTRO", "Pista:Es la persona encargada de enseñar y de guiar a los estudiantes en la escuela.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra5);

        puntuajeTextView5 = (TextView) findViewById(R.id.puntuaje_adivina5);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("ABRIGO", "PEINE", "MAESTRO"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            puntuajeTextView5.setText(String.valueOf(puntos));
            ...
            Intent intent = new Intent(AdivinaLaPalabra5.this, VictoriaAdivinaLaPalabra.class);
