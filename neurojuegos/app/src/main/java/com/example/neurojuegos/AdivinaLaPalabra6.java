...
public class AdivinaLaPalabra6 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 6;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("RECREO", "TAREA", "CLASE"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        ...
        put("TAREA", "Pista:Es un trabajo o asignación que los estudiantes deben completar en casa o en la escuela.");
        put("CLASE", "Pista: Es una sesión de enseñanza en la que los estudiantes aprenden sobre un tema específico.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra6);

        puntuajeTextView6 = (TextView) findViewById(R.id.puntuaje_adivina6);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("RECREO", "TAREA", "CLASE"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra6.this, VictoriaAdivinaLaPalabra.class);
