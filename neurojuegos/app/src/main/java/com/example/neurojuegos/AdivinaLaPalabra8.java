...
public class AdivinaLaPalabra8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra8);

        puntuajeTextView8 = (TextView) findViewById(R.id.puntuaje_adivina8);
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra8.this, VictoriaAdivinaLaPalabra.class);
