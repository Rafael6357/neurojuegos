...
public class AdivinaLaPalabra4 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 4;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("CAMISA", "FALDA", "ZAPATOS"));
    ...
    private TextView puntuajeTextView4;

    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("CAMISA", "Pista: Es una prenda de vestir que se usa en la parte superior del cuerpo y que tiene mangas cortas.");
        put("FALDA", "Pista: Es una prenda de vestir que se usa en la parte inferior del cuerpo y que cubre las piernas, pero es más corta que los pantalones y lo usan las niñas.");
        put("ZAPATOS", "Pista:Es un calzado que se usa en los pies y que protege de la lluvia, el frío y otros elementos.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra4);

        puntuajeTextView4 = (TextView) findViewById(R.id.puntuaje_adivina4);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("CAMISA", "FALDA", "ZAPATOS"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            puntuajeTextView4.setText(String.valueOf(puntos));
            ...
            Intent intent = new Intent(AdivinaLaPalabra4.this, VictoriaAdivinaLaPalabra.class);
