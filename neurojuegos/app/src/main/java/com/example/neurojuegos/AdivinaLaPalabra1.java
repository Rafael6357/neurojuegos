...
public class AdivinaLaPalabra1 extends AppCompatActivity {
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("MESA", "Pista:Mueble para comer.");
        put("VASO", "Pista:Se utiliza para beber.");
        put("SILLA", "Pista:Mueble para sentarse.");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra1);

        // Inicializar las vistas después de setContentView
        puntuajeTextView1 = findViewById(R.id.puntuaje_adivina1);
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra1.this, VictoriaAdivinaLaPalabra.class);
