...
public class Identifica5 extends AppCompatActivity {
    private TextView puntuajeTextView5;
    private String nombreJugadorActual;
    private int nivelActual = 5;
    private Button reiniciarButton;
    private Button verificarButton5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica5);
        puntuajeTextView5 = (TextView) findViewById(R.id.puntuaje_identifica5);

        // Obtener la referencia del botón verificar
        Button verificarButton5 =(Button) findViewById(R.id.verificar5activityidentifica);

        // Agregar el método onClick al botón verificar
        verificarButton5.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // Obtener la referencia del botón volver a niveles
            ImageView regresarANiveles5 = findViewById(R.id.regresarANiveles5);

        // Agregar el método onClick del botón volver a niveles
        regresarANiveles5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Volver_A_Niveles();
            }
    ...
    public void Verificar5Respuesta() {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(Identifica5.this, VictoriaIdentifica.class);
