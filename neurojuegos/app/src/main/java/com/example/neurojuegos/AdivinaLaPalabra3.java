...
public class AdivinaLaPalabra3 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 3;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("MESA", "VASO", "SILLA"));
    ...
    private TextView puntuajeTextView3;

    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("RECREO", "Pista: Es un momento del día en el que los estudiantes pueden jugar, descansar o hacer actividades recreativas.");
        put("LÁPIZ", "Pista:Es un objeto que se utiliza para escribir y que tiene una punta que puede ser de grafito o de tinta.");
        put("PAPEL", "Pista:Es un material que se utiliza para escribir, dibujar");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra3);

        puntuajeTextView3 = (TextView) findViewById(R.id.puntuaje_adivina3);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("RECREO", "LÁPIZ", "PAPEL"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            puntuajeTextView3.setText(String.valueOf(puntos));
            ...
            Intent intent = new Intent(AdivinaLaPalabra3.this, VictoriaAdivinaLaPalabra.class);
