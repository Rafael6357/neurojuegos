...
public class Identifica14 extends AppCompatActivity {
    private TextView puntuajeTextView14;
    private String nombreJugadorActual;
    private int nivelActual = 14;
    private Button reiniciarButton;
    private Button verificarButton14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica14);
        puntuajeTextView14 = (TextView) findViewById(R.id.puntuaje_identifica14);

        // Obtener la referencia del botón verificar
        Button verificarButton14 =(Button) findViewById(R.id.verificar14activityidentifica);

        // Agregar el método onClick al botón verificar
        verificarButton14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Verificar14Respuesta();
            }
        });

        // Obtener la referencia del botón volver a niveles
        ImageView regresarANiveles14 = findViewById(R.id.regresarANiveles14);

        // Agregar el método onClick del botón volver a niveles
        regresarANiveles14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Volver_A_Niveles();
            }
    ...
    public void Verificar14Respuesta() {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(Identifica14.this, VictoriaIdentifica.class);
