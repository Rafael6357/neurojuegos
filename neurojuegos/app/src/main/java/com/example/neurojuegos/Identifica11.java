...
public class Identifica11 extends AppCompatActivity {
    private TextView puntuajeTextView11;
    private String nombreJugadorActual;
    private int nivelActual = 11;
    private Button reiniciarButton;
    private Button verificarButton11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica11);
        puntuajeTextView11 = (TextView) findViewById(R.id.puntuaje_identifica11);

        // Obtener la referencia del botón verificar
        Button verificarButton10 =(Button) findViewById(R.id.verificar11activityidentifica);
    ...
    public void Verificar11Respuesta() {
        ...
        if (chSeleccionado1.isChecked() && chSeleccionado4.isChecked() && chSeleccionado3.isChecked() && !chSeleccionado2.isChecked() ) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(Identifica11.this, VictoriaIdentifica.class);
            intent.putExtra("nivel_maxIdentifica", nivelActual);
            startActivity(intent);
        }

        else {
            Toast.makeText(this, "Lo siento, respuesta incorrecta, CLICK EN REINICIAR NIVEL e intenta de nuevo.", Toast.LENGTH_SHORT).show();
        }
