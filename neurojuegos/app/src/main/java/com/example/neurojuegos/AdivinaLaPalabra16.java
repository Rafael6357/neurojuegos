...
public class AdivinaLaPalabra16 extends AppCompatActivity {
    private String palabraOculta;
    private int intentosRestantes;

    private int nivelActual = 16;

    private ArrayList<String> listaPalabras = new ArrayList<>(Arrays.asList("ALMUERZO", "ROPA", "COMIDA"));
    ...
    private HashMap<String, String> pistasPalabras = new HashMap<String, String>() {{
        put("BICICLETA", "Pista:Vehículo de dos ruedas que se impulsa con pedales.");
        put("RELOJ", "Pista:Objeto que muestra la hora y se usa para medir el tiempo.");
        put("GIRAFA", "Pista:Animal con cuello muy largo y manchas en su pelaje.\n");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adivina_la_palabra16);

        puntuajeTextView16 = (TextView) findViewById(R.id.puntuaje_adivina16);
        ...
        listaPalabras = new ArrayList<>(Arrays.asList("BICICLETA", "RELOJ", "GIRAFA"));
    ...
    public void ingresarLetra(View view) {
        ...
        if (textoPalabraOculta.getText().toString().replace(" ", "").equals(palabraOculta)) {
            ...
            Intent intent = new Intent(AdivinaLaPalabra16.this, VictoriaAdivinaLaPalabra.class);
