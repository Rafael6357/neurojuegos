...
public class Identifica3 extends AppCompatActivity {
    private TextView puntuajeTextView3;
    private String nombreJugadorActual;
    private int nivelActual = 3;
    private Button reiniciarButton;
    private Button verificarButton3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identifica3);
        puntuajeTextView3 = (TextView) findViewById(R.id.puntuaje_identifica3);

        // Obtener la referencia del botón verificar
        Button verificarButton3 =(Button) findViewById(R.id.verificar3activityidentifica);

        // Agregar el método onClick al botón verificar
        verificarButton3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ImageView regresarANiveles3  = findViewById(R.id.regresarANiveles3);

        // Agregar el método onClick del botón volver a niveles
        regresarANiveles3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Volver_A_Niveles();
            }
    ...
    public void Verificar3Respuesta() {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////se mostro puntos
            ...
            Intent intent = new Intent(Identifica3.this, VictoriaIdentifica.class);
